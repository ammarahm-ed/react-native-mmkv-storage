...
var INDEX_TYPE = 'stringIndex';
/**
 * Index of all string values in storage
 */
var stringsIndex = /** @class */ (function () {
    function stringsIndex(id) {
        this.instanceID = id;
    }
    /**
     * Get all keys
     */
    stringsIndex.prototype.getKeys = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, handleActionAsync(mmkvJsiModule.getIndexMMKV, INDEX_TYPE, this.instanceID)];
     ...
     */
    stringsIndex.prototype.getAll = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                return [2 /*return*/, new Promise(function (resolve) {
                        var keys = handleAction(mmkvJsiModule.getIndexMMKV, INDEX_TYPE, _this.instanceID);
                        if (!keys)
                            keys = [];
                        var items = [];
